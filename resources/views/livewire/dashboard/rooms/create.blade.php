                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control @error('price_per_hour') is-invalid @enderror"
                            id="price_per_hour" wire:model="price_per_hour" step="0.01" min="0"
                            placeholder="0.00">
                    ...
                    <div class="card border-primary">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="price_per_hour_2_controllers" class="form-label">Price for 2
                                        Controllers</label>
                                    <div class="input-group">
                                        <span class="input-group-text">$</span>
                                        <input type="number"
                                            class="form-control @error('price_per_hour_2_controllers') is-invalid @enderror"
                                            id="price_per_hour_2_controllers" wire:model="price_per_hour_2_controllers"
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="price_per_hour_4_controllers" class="form-label">Price for 4
                                        Controllers</label>
                                    <div class="input-group">
                                        <span class="input-group-text">$</span>
                                        <input type="number"
                                            class="form-control @error('price_per_hour_4_controllers') is-invalid @enderror"
                                            id="price_per_hour_4_controllers" wire:model="price_per_hour_4_controllers"
                                            step="0.01" min="0" placeholder="0.00">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="is_vip" wire:model="is_vip">
