...
class Edit extends Component
{
    ...
    public function update()
    {
        ...
        $this->dispatch('success', 'Room updated successfully!');
        $this->dispatch('closeEditModal');
        $this->dispatch('refreshTable');

        // Reset form
        $this->reset(['roomId', 'name', 'type', 'price_per_hour', 'price_per_hour_2_controllers', 'price_per_hour_4_controllers', 'is_vip', 'status']);
    }

    public function render()
    {
        return view('livewire.dashboard.rooms.edit');
    }
}
